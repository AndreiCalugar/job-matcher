...
2. `ranking.json` — the same ids (or the row numbers from POSTINGS.md's table), ordered **by you**, best fit first. No ties. This is the ground truth; if the model disagrees, the model is wrong.
