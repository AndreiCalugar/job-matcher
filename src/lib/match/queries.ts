...
export async function getMatchForJob(jobId: string, profileId: string): Promise<MatchRow | null> {
...
export async function getMatchesByJob(jobIds: string[], profileId: string): Promise<Map<string, MatchRow>> {
